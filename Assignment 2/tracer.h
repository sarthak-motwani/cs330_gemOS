...
{
    char *trace_mem_addr; // this would be the memory location of the trace buffer
    u32 read_offset;
    u32 write_offset;
    int is_full;  // is_full = 1 if the trace buffer is full, otherwise 0
    int is_empty; // is_empty = 1 if the buffer is empty, otherwise 0
};
